# Form implementation generated from reading ui file 'crudlist.ui'
#
...
from PyQt6.QtWidgets import QDialog, QInputDialog, QLineEdit, QWidget, QMessageBox


class Ui_Dialog(QDialog):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(547, 451)
    ...
    def remove_item(self):
        ...
        if item is None:
            return
        reply = QMessageBox.question(self, "Remove Item", "Do you want to remvove this item", QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
